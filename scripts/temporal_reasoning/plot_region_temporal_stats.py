...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="可视化区域分析报告中的光流与颜色指标")
    parser.add_argument("--report", required=True, help="region_analysis_report.json 路径")
